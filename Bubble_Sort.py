...
class BubbleSortVisualizer:
    def __init__(self, root):
        ...
        self.current_state = {
            ...
            "swapping": None,   # (i, j) indices being swapped
            "pass_num": 0
        }
    ...
    def start_sorting(self):
        """Start the bubble sort visualization process."""
        if self.is_sorting:
        ...
        try:
            ...
            # Perform bubble sort visualization
            self.bubble_sort_with_viz()
    ...
    def bubble_sort_with_viz(self):
        """Perform bubble sort with visualization steps."""
        # Store initial state
        state = {
            "type": "initial",
            "array": self.array[:],
...
if __name__ == "__main__":
    ...
    image_path = os.path.join(images_dir, "images", "bubble_sort.png")
